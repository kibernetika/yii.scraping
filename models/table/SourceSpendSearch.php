...
/**
 * SourceSpendSearch represents the model behind the search form about `app\models\table\SourceSpend`.
 */
class SourceSpendSearch extends SourceSpend
{
    public $source;
    public $user;
    public $startDate;
