...
/* @var $searchModel app\models\table\SourceReturnSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Source return (Affiliate Network)';
...
<div class="source-return-index">
    ...
    padding: 10px; margin-left: 10px; height: 100%; width: 170px; ">
        <div style="color: #d9534f">Total: <strong><?= number_format($total, 2, '.', ' ') ?> $</strong></div>
        <p></p>
        <div style="color: #00aa00">Average: <strong><?= number_format($average, 2, '.', ' ') ?> $</strong></div>
    </div>
        ...
        'columns' => [
            ...
            [
                ...
                'filter' => Html::activeDropDownList($searchModel, 'id_source', ArrayHelper::map(
                    Source::find()->where('type=2')->orderBy(['name' => SORT_ASC])->asArray()->all(), 'id', 'name'
